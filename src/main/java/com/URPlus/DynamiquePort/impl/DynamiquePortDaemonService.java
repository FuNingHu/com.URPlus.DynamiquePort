...
public class DynamiquePortDaemonService implements DaemonService {

	private DaemonContribution daemonContribution;

	public DynamiquePortDaemonService() {
	}
	...
	public void init(DaemonContribution daemonContribution) {
		...
		try {
			daemonContribution.installResource(new URL("file:com/ur/urcap/examples/dynamiquePort/impl/daemon/"));
	...
	public URL getExecutable() {
		try {
			...
			return new URL("file:com/ur/urcap/examples/dynamiquePort/impl/daemon/dynamiquePort.py"); // Python executable
